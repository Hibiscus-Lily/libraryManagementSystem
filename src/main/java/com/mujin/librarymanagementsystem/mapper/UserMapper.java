...
public interface UserMapper {
    ...
    //管理员添加用户
    @Select("insert into user(username,account, password,state,jurisdiction,loginStatus) values(#{username},#{account},#{password},#{state},#{jurisdiction},#{loginStatus})")
    void adminAddUser(@Param("username") String username, @Param("account") String account, @Param("password") String password, @Param("state") Integer state, @Param("jurisdiction") Integer jurisdiction, @Param("loginStatus") Integer loginStatus);
